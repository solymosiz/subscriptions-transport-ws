...
export declare class SubscriptionClient {
    ...
    private dataLoadImpl;
    private dataDumpImpl;
    ...
    constructor(url: string, options?: ClientOptions, webSocketImpl?: any, webSocketProtocols?: string | string[], dataLoadImpl?: any, dataDumpImpl?: any);
    get status(): any;
    close(isForced?: boolean, closedByUser?: boolean, closeCode?: number): void;
